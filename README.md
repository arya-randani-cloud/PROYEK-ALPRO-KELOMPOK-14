...
RoleContoh akunTampilan yang munculUser arya123 / jogja2026, atau user2 / pass2Menu belanja pelanggan (modPelanggan) + sistem pemesanan cepat (modPemesanan)Adminadmin01 / ceran2026adminLangsung ke Dashboard Admin Mall (modVendor::menuAdminMall) Tokoadmin / admin123, atau toko01 / toko2026 registrasi toko baru (modAddAdmin) + dashboard toko lengkap (modAdminFinal)
